1070
((3) 0 () 2 ((q lib "make/main.rkt") (q 521 . 5)) () (h ! (equal) ((q form ((lib "make/make-sig.rkt") make^)) q (1009 . 2)) ((c form c (c (? . 0) q make)) q (0 . 5)) ((c def c (c (? . 0) q make-print-checking)) q (699 . 4)) ((c def c (c (? . 0) q make-print-reasons)) q (909 . 4)) ((c def c (c (? . 0) q exn:fail:make-orig-exn)) c (? . 1)) ((c def c (c (? . 0) q exn:fail:make)) c (? . 1)) ((c def c (c (? . 0) q make-print-dep-no-line)) q (801 . 4)) ((c def c (c (? . 0) q make/proc)) q (127 . 8)) ((c def c (c (? . 0) q exn:fail:make-targets)) c (? . 1)) ((q form ((lib "make/collection-sig.rkt") make:collection^)) q (2324 . 2)) ((q def ((lib "make/setup-extension.rkt") pre-install)) q (1061 . 25)) ((q def ((lib "make/make-unit.rkt") make@)) q (1039 . 2)) ((q def ((lib "make/collection-unit.rkt") make:collection@)) q (2365 . 2)) ((c def c (c (? . 0) q struct:exn:fail:make)) c (? . 1)) ((c def c (c (? . 0) q exn:fail:make?)) c (? . 1)) ((c def c (c (? . 0) q make-exn:fail:make)) c (? . 1)) ((q def ((lib "make/collection.rkt") make-collection)) q (2050 . 7))))
syntax
